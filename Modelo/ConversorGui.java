    ...
    private void jComboBoxOpcionMoneda2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxOpcionMoneda2ActionPerformed
        ...
        jComboBoxOpcionPrimerMoneda.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                /*Si selecciona "Peso colombiano" como primera opción, 
                  se agregan todas las opciones al 2do combobox sin incluir "Peso Colombiano". */
                if(jComboBoxOpcionPrimerMoneda.getSelectedItem().toString().equals("Peso Colombiano")){
                    
                    // Eliminar todos los elementos de "jComboBoxOpcionMoneda2".
                ...
                for (Moneda moneda : monedas) {
                    ...
                    // Agregar al "jComboBoxOpcionMoneda2" los nombres de las monedas diferentes a "Peso Colombiano"
                    if (!seleccion.equals(moneda.getNombre())) {
                        jComboBoxOpcionMoneda2.addItem(moneda.getNombre());
                    }
                }
                
                /*Si la opcion es diferente a "Peso colombiano", la conversión seria inversa y 
                  solo permitiria convertir a "Peso Colombiano". */
                }else{
                    
                    //Elimina todos los elementos de "jComboBoxOpcionMoneda2".
                    jComboBoxOpcionMoneda2.removeAllItems();
                    
                    //Agrega "Peso Colombiano" a "jComboBoxOpcionMoneda2".
